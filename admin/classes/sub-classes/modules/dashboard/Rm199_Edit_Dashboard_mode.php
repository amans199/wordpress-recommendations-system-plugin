...
?>
        ...
        <div class="rm199__home_col--lg">
            ...
            <div class="rm199_input">
                ...
                <input id="rm199__description_input" type="text" placeholder="<?php _e('Enter a Description here', 'rm199') ?>" onkeyup="rm199_description(this.value)" aria-describedby="rm199__description" value="<?php echo $description; ?>">
                <small id="rm199__description"><?php _e('What do you want this Shortcode to do !? ', 'rm199') ?></small>
            </div>

            <!-- filter by keyword -->
            <div class="rm199_input--row">
                <input type="checkbox" id="filter_by_keyword" onclick="rm199_filter_by_keyword()" <?php echo $can_user_select_keywords; ?>>
                <label for="filter_by_keyword"><?php _e('Allow users to select Keywords', 'rm199') ?></label>
            </div>
            <!-- show only for logged in -->
            <div class="rm199_input--row">
                <input type="checkbox" id="show_only_for_loggedin_users" onclick="rm199_show_only_for_loggedin_users()" <?php echo $show_only_for_loggedin_users; ?>>
            ...
            <div class="rm199_input--row">
                ...
                <select name="rm199_categories" id="rm199_categories" onchange="rm199_categories(this.value)" <?php echo ($all_categories != '' ? 'disabled' : ''); ?>>
                    <option value="all"><?php _e('All', 'rm199') ?></option>
                    <?php
            ...
            <div class="rm199_input rm199_input_more_categories" <?php echo ($all_categories != '' ?: 'style="display: none;"'); ?>>
                ...
                <input id="rm199__more_categories_input" type="text" aria-describedby="rm199__more_categories_input_info" placeholder="<?php _e('books,pants,shirts', 'rm199') ?>" onkeyup="rm199_categories(this.value)" value="<?php echo ($all_categories ?: ''); ?>">
            </div>
            ...
            <div class="rm199_input--row">
                ...
                <select name="rm199_tags" id="rm199_tags" onchange="rm199_tags(this.value)" <?php echo ($all_tags != '' ? 'disabled' : ''); ?>>
                    <option value="all"><?php _e('All', 'rm199') ?></option>
                    <?php
            ...
            <div class="rm199_input rm199_input_more_tags" <?php echo ($all_tags != '' ?: 'style="display: none;"'); ?>>
                ...
                <input id="rm199__more_tags_input" type="text" aria-describedby="rm199__more_tags_input_info" placeholder="<?php _e('football,english,europe', 'rm199') ?>" onkeyup="rm199_tags(this.value)" value="<?php echo ($all_tags ?: ''); ?>">
            </div>
            <!-- end tags customizer  -->
            ...
            <div class="choose_global_styles">
                <div class="rm199_input--row">
                    ...
                    <input class="mx-2" type="color" id="choose_main_color" name="main-color" onchange="choose_main_color(this.value)" value="<?php echo $main_color; ?>">
                </div>
                <div class="rm199_input--row">
                    <label for="choose_secondary_color" style="min-width: 220px;"><?php _e('Choose secondary color ', 'rm199') ?></label><br>
                    <input class="mx-2" type="color" id="choose_secondary_color" name="secondary-color" onchange="choose_secondary_color(this.value)" value="<?php echo $secondary_color; ?>">
                </div>
                <div class="rm199_input--row">
                    <label for="choose_text_color" style="min-width: 220px;"><?php _e('Choose text color ', 'rm199') ?></label><br>
                    <input class="mx-2" type="color" id="choose_text_color" name="text-color" onchange="choose_text_color(this.value)" value="<?php echo $text_color; ?>">
                </div>
                <?php
                ...
                <div class="rm199_input--column">
                    ...
                    <textarea name="code-custom-css" class="w-100" id="code_custom_css" rows="10" onchange="choose_code_custom_css(this.value)" placeholder="<?php _e('.rm199_post__link {color:#000;}', 'rm199') ?>"><?php echo $custom_styles; ?></textarea>
                </div>
            </div>
        </div>
